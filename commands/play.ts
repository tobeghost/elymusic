...
import { ChatInputCommandInteraction, PermissionsBitField, SlashCommandBuilder, TextChannel, EmbedBuilder, Colors } from "discord.js";
  ...
  async execute(interaction: ChatInputCommandInteraction, input: string) {
    ...
    if (!channel) {
      const embed = new EmbedBuilder()
        .setTitle(i18n.__("play.errorNotChannel"))
